...
<div class="col-lg-12" style="z-index:-1;">
	<div class="row">
          <img src="resources/images/Sony Page img.png" style="height:550px;width:1440px;float:center;" class="img-responsive" >
...
<div class="row">
	...
	<div class="col-lg-12 pb" style=" border: 3px dashed gray ;">
		<center><h3> <b>Xperia Z5</b> </h3></center>
		<img class="col-lg-12 img-resposive" src="resources/images/sonypage/Xperia Z5.jpg" style="height: 320px;">
		<div class="col-lg-12">
	...
	<div class="col-lg-3">
	<div class="col-lg-12 pb" style=" border: 3px dashed gray;">
		<center><h3> <b>Xperia XZ</b> </h3></center>
		<img class="col-lg-12 img-resposive" src="resources/images/sonypage/Xperia XZ.png" style="height: 320px;">
		<div class="col-lg-12">
			<div class="col-lg-3"></div>
			<div class="col-lg-6">
				<a href="#"><button type="button" class="explore_btn" style="color: black;"> Details </button></a>
	...
	<div class="col-lg-3">
	<div class="col-lg-12 pb" style=" border: 3px dashed gray;">
		<center><h3> <b>Xperia C5</b> </h3></center>
		<img class="col-lg-12 img-resposive" src="resources/images/sonypage/Xperia C5.png" style="height: 320px;">
		<div class="col-lg-12">
			<div class="col-lg-3"></div>
			<div class="col-lg-6">
				<a href="#"><button type="button" class="explore_btn" style="color: black;"> Details </button></a>
	...
	<div class="col-lg-3">
	<div class="col-lg-12 pb" style=" border: 3px dashed gray;">
		<center><h3> <b>Xperia M4</b> </h3></center>
		<img class="col-lg-12 img-resposive" src="resources/images/sonypage/Xperia M4.jpg" style="height: 320px;">
		<div class="col-lg-12">
			<div class="col-lg-3"></div>
			<div class="col-lg-6">
				<a href="#"><button type="button" class="explore_btn" style="color: black;"> Details </button></a>
