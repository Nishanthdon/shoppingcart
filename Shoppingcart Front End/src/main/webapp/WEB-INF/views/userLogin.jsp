...
<div class="col-lg-5 pc">
	...
	<a href="SamsungPage"><button type="button" class="explore_btn lbut" style="color: black;">Explore</button></a>
...
<div class="col-lg-5 pc">
	...
	<div class="col-lg-12 pnn " style="">  </div>
	<a href="SonyPage"><button type="button" class="explore_btn rbut" style="color: black;">Explore</button></a>
...
<div class="col-lg-5 pc">
	...
	<div class="col-lg-12 pnn " style="">  </div>
	<a href="MotorolaPage"><button type="button" class="explore_btn" style="color: black;">Explore</button></a>
...
<div class="col-lg-5 pc">
	...
	<div class="col-lg-12 pnn " style="">  </div>
	<a href="VivoPage"><button type="button" class="explore_btn rbut" style="color: black;">Explore</button></a>
...
<c:if test="${isUserClickedSony=='true'}">
		<jsp:include page="Sony.jsp"></jsp:include>
	</c:if>

<c:if test="${isUserClickedSamsung=='true' }">
		<jsp:include page="Samsung.jsp"></jsp:include>
	</c:if>
	
<c:if test="${isUserClickedMotorola=='true'}">
		<jsp:include page="Motorola.jsp"></jsp:include>
	</c:if>

<c:if test="${isUserClickedVivo=='true' }">
		<jsp:include page="Vivo.jsp"></jsp:include>
	</c:if>
